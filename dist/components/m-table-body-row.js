...
var _useDoubleClick3 = require("../utils/hooks/useDoubleClick");
...
function MTableBodyRow(props) {
  ...
  var _useDoubleClick = (0, _useDoubleClick3.useDoubleClick)(onRowClick ? function (e) {
    return onClick(e, onRowClick);
  } : undefined, onDoubleRowClick ? function (e) {
    return onClick(e, onDoubleRowClick);
  } : undefined, onClick),
      _useDoubleClick2 = (0, _slicedToArray2["default"])(_useDoubleClick, 1),
      doubleClickRef = _useDoubleClick2[0];
  ...
  var renderSelectionColumn = function renderSelectionColumn() {
    ...
    return /*#__PURE__*/_react["default"].createElement(_TableCell["default"], {
      ...
      onChange: function onChange(event) {
        return props.onRowSelected(event, props.path, props.data);
      },
      style: styles
    }, checkboxProps)));
  };
  ...
  }), renderColumns), props.data.tableData && props.data.tableData.showDetailPanel && /*#__PURE__*/_react["default"].createElement(_TableRow["default"] // selected={props.index % 2 === 0}
  , null, props.options.detailPanelOffset.left > 0 && /*#__PURE__*/_react["default"].createElement(_TableCell["default"], {
    colSpan: props.options.detailPanelOffset.left
  }), /*#__PURE__*/_react["default"].createElement(_TableCell["default"], {
    size: size,
    colSpan: renderColumns.length - props.options.detailPanelOffset.left - props.options.detailPanelOffset.right,
    padding: "none"
  }, props.data.tableData.showDetailPanel(props.data))), props.data.tableData.childRows && props.data.tableData.isTreeExpanded && props.data.tableData.childRows.map(function (data, index) {
